...
# app.config['SQLALCHEMY_ECHO'] = True # Debug de teste do banco de dados
db.init_app(app)
...
def home() -> str:
    """
    Rota principal da aplicação, faz uma saudação, apresenta a API e exibe
    links de ajuda para usar a aplicação.
